...
<h3>Setting up a Blog in Quarto</h3>
...
Under 'Build and Deployment' click on the Drop down menu of the directory your blog is being deployed from, and select /docs instead of /(root).
